	...
	<body>
		...
		<div id="show-municipio" class="content scaffold-show" role="main">
			...
			<ol class="property-list municipio">
				...
				<g:if test="${municipioInstance?.rutaImagen}">
				<li class="fieldcontain">
					<span id="rutaImagen-label" class="property-label"><g:message code="municipio.rutaImagen.label" default="Ruta Imagen" /></span>
					
						<span class="property-value" aria-labelledby="rutaImagen-label"><g:fieldValue bean="${municipioInstance}" field="rutaImagen"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${municipioInstance?.rutaImagenSel}">
				<li class="fieldcontain">
					<span id="rutaImagenSel-label" class="property-label"><g:message code="municipio.rutaImagenSel.label" default="Ruta Imagen Sel" /></span>
					
						<span class="property-value" aria-labelledby="rutaImagenSel-label"><g:fieldValue bean="${municipioInstance}" field="rutaImagenSel"/></span>

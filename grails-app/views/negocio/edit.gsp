...
<html>
	...
	<body>
		<a href="#edit-negocio" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-negocio" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${negocioInstance?.version}" />
				<fieldset class="form">

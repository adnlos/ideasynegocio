...
<html>
	...
	<body>
		<a href="#edit-paquete" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-paquete" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${paqueteInstance?.version}" />
				<fieldset class="form">

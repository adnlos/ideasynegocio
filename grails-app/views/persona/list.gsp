			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="calle" title="${message(code: 'persona.calle.label', default: 'Calle')}" />
					
						<th><g:message code="persona.colonia.label" default="Colonia" /></th>
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personaInstance, field: "calle")}</td>

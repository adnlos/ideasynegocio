	...
	<body>
		...
		<div id="show-colonia" class="content scaffold-show" role="main">
			...
			<ol class="property-list colonia">
				...
				<g:if test="${coloniaInstance?.nombreCompleto}">
				<li class="fieldcontain">
					<span id="nombreCompleto-label" class="property-label"><g:message code="colonia.nombreCompleto.label" default="Nombre Completo" /></span>
					
						<span class="property-value" aria-labelledby="nombreCompleto-label"><g:fieldValue bean="${coloniaInstance}" field="nombreCompleto"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${coloniaInstance?.tipoColonia}">
				<li class="fieldcontain">
					<span id="tipoColonia-label" class="property-label"><g:message code="colonia.tipoColonia.label" default="Tipo Colonia" /></span>
					
						<span class="property-value" aria-labelledby="tipoColonia-label"><g:fieldValue bean="${coloniaInstance}" field="tipoColonia"/></span>

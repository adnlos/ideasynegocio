			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="tipoColonia" title="${message(code: 'colonia.tipoColonia.label', default: 'Tipo Colonia')}" />
				...
				<g:each in="${coloniaInstanceList}" status="i" var="coloniaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: coloniaInstance, field: "tipoColonia")}</td>
